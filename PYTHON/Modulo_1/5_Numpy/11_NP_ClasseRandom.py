...
"""
CLASS RANDOM numpy.random
generare numeri casuali.
serve per testare un algoritmo, simulare scenari, o inizializzare valori
con numpy.random posso:
- numeri casuali, uniformi o distribuiti, secondo varie leggi matematiche
- estrazione di campioni da distribuzioni statistiche
- funzioni per mescolare o scegliere elementi a caso
indispensabile per chi lavora con dati e simulazioni
"""
print("**********************")
